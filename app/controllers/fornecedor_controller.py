...
class Fornecedor_Controller:
    ...
    def save(self):
        try:
            ...
            self.view.exibir_mensagem(f"{Idioma.t('comum.erro_prefixo')}{Idioma.t('fornecedor.erro_entrada_invalida')}", False)
    ...
    def delete(self):
        ...
        try:
            ...
            self.view.exibir_mensagem(Idioma.t("fornecedor.erro_ao_excluir"), False)
    ...
    def abrir_categorias(self):
        ...
        if not categorias_disponiveis:
            self.view.exibir_mensagem(Idioma.t("fornecedor.sem_categorias"), False)
            return
    ...
    def salvar_categorias(self, view_categorias, fornecedor, categorias_selecionadas):
        try:
            ...
            view_categorias.exibir_mensagem(Idioma.t("fornecedor.categorias_atualizadas_sucesso"))
            view_categorias.fechar()
        except Exception as e:
            view_categorias.exibir_mensagem(Idioma.t("fornecedor.erro_salvar_categorias"), False)